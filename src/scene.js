...
//console.log(ownerProfile);
 ...
 spots:[{id:15, pos:{x: -0.07060150805972984, y: -1.2, z: 5.704404830932617}, dims:{width:1.5, height: 1.5}},
        ...
        {id:13, pos:{x: -13.885168501713958, y: -1, z: 7.228099822998047}, dims:{width:1.5, height: 2.25}},
        {id:12, pos:{x: -13.708802988665713, y: -1, z: -7.377546310424806}, dims:{width:1.5, height: 2.25}},
        {id:11, pos:{x: -19.87673095703125, y: -1, z: 0.09557420748106615}, dims:{width:1.5, height: 3}, rot:{x:0,y:1.57079632679,z:0}},
        {id:10, pos:{x: 13.826883017001107, y: -1, z: -7.377546310424805}, dims:{width:1.5, height: 2.25}},
        {id:9, pos:{x: 13.694782536404347, y: -1, z: 7.228099822998047}, dims:{width:1.5, height: 2.25}},
        {id:8, pos:{x: 19.842348098754883, y: -1, z: 0.18324702120981307}, dims:{width:1.5, height: 3}, rot:{x:0,y:1.57079632679,z:0}},
        {id:7, pos:{x: 7.6974523925781275, y: -0.5, z: 11.73381267645709}, dims:{width:1.5, height: 3}, rot:{x:0,y:1.57079632679,z:0}},
        {id:6, pos:{x: -7.731833457946778, y: -0.5, z: 11.544662040888163}, dims:{width:1.5, height: 3}, rot:{x:0,y:1.57079632679,z:0}},
        {id:5, pos:{x: -0.07595948011816395, y: -0.5, z: 16.75197982788086}, dims:{width:1.5, height: 3}},
        {id:4, pos:{x: -0.013148501254326372, y: -1.2, z: 6.044923782348633}, dims:{width:1.5, height: 1.5}},
        {id:3, pos:{x: -7.731833457946777, y: -0.5, z: -11.617785725239571}, dims:{width:1.5, height: 2.25}, rot:{x:0,y:1.57079632679,z:0}},
        {id:2, pos:{x: 7.697452392578127, y: -0.5, z: -11.542924826859029}, dims:{width:1.5, height: 2.25}, rot:{x:0,y:1.57079632679,z:0}},
        {id:1, pos:{x: -0.06733116066026976, y: -0.5, z: -16.733196258544922}, dims:{width:1.5, height: 3}},
        {id:0, pos:{x: -0.10944072448069289, y: -1.2, z: -6.047203540802002}, dims:{width:1.5, height: 1.5}}]
}]
